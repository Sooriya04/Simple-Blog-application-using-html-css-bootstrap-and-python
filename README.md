...
## Dynamic Blog Application with Flask
<p>A responsive blog platform built with HTML, CSS, and Python Flask. Features include JSON API integration for content enrichment, a contact form using smtplib, and a mobile-friendly design for a seamless user experience</p>
<h3>About This Project</h3>
This blog application is a dynamic web platform designed to showcase and manage blog content efficiently. Built using HTML and CSS for the frontend, and Python with Flask for the backend, this project integrates several key features:

JSON API Integration: The application uses the requests module to fetch and display data from external JSON APIs, enhancing the content and functionality of the blog.
Contact Form: It includes a contact form that utilizes smtplib for sending emails, allowing users to reach out directly from the website.
Mobile Responsiveness: The design ensures a seamless user experience across various devices, from desktops to mobile phones.
Flask Backend: The backend is powered by Flask, providing a robust framework for handling routes, templates, and data management.
This combination of technologies creates a versatile and user-friendly blog application suitable for various blogging needs.
## 📥 Download and Installation
To get started with **Blog**, you can easily clone the repository to your local machine. Follow these steps:
...
```bash
git clone https://github.com/Sooriya04/Simple-Blog-application-using-html-css-bootstrap-and-python.git
```
### To Run the file
